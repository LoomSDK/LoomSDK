...
:VS2013-X64-CMAKE
cmake .. -G "Visual Studio 12" -DLOOM_BUILD_JIT=%1 -DLOOM_BUILD_NUMCORES=%2 %3 -DLOOM_BUILD_ADMOB=%4 -DLOOM_BUILD_FACEBOOK=%5
EXIT
...
:VS2012-X64-CMAKE
cmake .. -G "Visual Studio 11" -DLOOM_BUILD_JIT=%1 -DLOOM_BUILD_NUMCORES=%2 %3 -DLOOM_BUILD_ADMOB=%4 -DLOOM_BUILD_FACEBOOK=%5
EXIT
...
:VS2010-X64-CMAKE
cmake .. -G "Visual Studio 10" -DLOOM_BUILD_JIT=%1 -DLOOM_BUILD_NUMCORES=%2 %3 -DLOOM_BUILD_ADMOB=%4 -DLOOM_BUILD_FACEBOOK=%5
EXIT
