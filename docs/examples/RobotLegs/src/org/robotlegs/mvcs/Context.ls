...
package org.robotlegs.mvcs
{
	...
	import org.robotlegs.adapters.LoomInjector;
	import org.robotlegs.adapters.LoomReflector;
	...
	public class Context extends ContextBase implements IContext
	{
		...
		{
			var injector:IInjector = new LoomInjector();
			return injector;
		}
		...
		{
			return injector.createChild(null);
		}
