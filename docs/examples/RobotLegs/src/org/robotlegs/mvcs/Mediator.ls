...
package org.robotlegs.mvcs
{
	...
	public class Mediator extends MediatorBase
	{
		 ...
		 * 
		 */		
		protected function addViewListener(type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = true):void
		{
			eventMap.mapListener(EventDispatcher(viewComponent), type, listener, 
		 ...
		 *
		 */
		protected function removeViewListener(type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false):void
		{
			eventMap.unmapListener(EventDispatcher(viewComponent), type, listener,
		 ...
		 * 
		 */		
		protected function addContextListener(type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = true):void
	 	{
		...
		/**
		 * Syntactical sugar for unmapping a listener from an <code>EventDispatcher</code>
		 *
		 * @param dispatcher
		 * @param type
		 * @param listener
		 ...
		 *
		 */
		protected function removeContextListener(type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false):void
	 	{
