...
package org.robotlegs.core
{
	...
	public interface IInjector
	{
		 ...
		 */
		function mapValue(whenAskedFor:Type, useValue:Object, named:String = ""):Object;
		 ...
		 * @return * A reference to the rule for this injection. To be used with <code>mapRule</code>
		 */
		function mapClass(whenAskedFor:Type, instantiateClass:Type, named:String = ""):Object;
		 ...
		 * @return * A reference to the rule for this injection. To be used with <code>mapRule</code>
		 */
		//function mapSingleton(whenAskedFor:Type, named:String = ""):Object;
		 ...
		 * @return * A reference to the rule for this injection. To be used with <code>mapRule</code>
		 */
		//function mapSingletonOf(whenAskedFor:Type, useSingletonOf:Type, named:String = ""):Object;
		 ...
		 * @return * A reference to the rule for this injection. To be used with <code>mapRule</code>
		 */
		//function mapRule(whenAskedFor:Type, useRule:Object, named:String = ""):Object;
		 ...
		 */
		function instantiate(clazz:Type):Object;
		 ...
		 * @return * An instance
		 */		
		//function getInstance(clazz:Type, named:String = ""):Object;
		 ...
		 * @return The injector 
		 */		
		function createChild(applicationDomain:Object = null):IInjector;
		 ...
		 * @param named An optional name (id)
		 */
		function unmap(clazz:Type, named:String = ""):void;
		
		/**
		 * Does a rule exist to sassify such a request?
		 * 
		 * @param clazz A class or interface
		 * @param named An optional name (id)
		 * @return Whether such a mapping exists
		 */		
		function hasMapping(clazz:Type, named:String = ""):Boolean;
		
		/**
		 * @return The Application Domain
		 */		
		function get applicationDomain():Object;
		
		/**
		 * @param value The Application Domain
		 */		
		function set applicationDomain(value:Object):void;
