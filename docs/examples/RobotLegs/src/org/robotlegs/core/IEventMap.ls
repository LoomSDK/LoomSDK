...
package org.robotlegs.core
{
	...
	public interface IEventMap
	{
		 ...
		 */
		function mapListener(dispatcher:EventDispatcher, type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = true):void;
		 ...
		 * @param useCapture
		 */
		function unmapListener(dispatcher:EventDispatcher, type:String, listener:Function, eventClass:Type = null, useCapture:Boolean = false):void;
