...
package org.robotlegs.core
{
	...
	public interface IMediatorMap
	{
		 ...
		 */
		function mapView(viewClassOrName:Object, mediatorClass:Type, injectViewAs:Object = null, autoCreate:Boolean = true, autoRemove:Boolean = true):void;
		 ...
		 * @param viewClassOrName The concrete view Class or Fully Qualified Class Name
		 */		
		function unmapView(viewClassOrName:Object):void;
		 ...
		 */
		function hasMapping(viewClassOrName:Object):Boolean;
