package 
{
	...
	public class ControllerButton extends Sprite
	{
		...
		public static const BUTTON_GUIDE:String = "guideButton";
		...
		protected function init()
		{
			switch(mType) {
				...
				case BUTTON_BUMPER:
					...
					break;
				case BUTTON_GUIDE:
					normal = new Image(Texture.fromAsset("assets/controller/guide.png"));
					pressed = new Image(Texture.fromAsset("assets/controller/guide-pressed.png"));
					break;
			}
