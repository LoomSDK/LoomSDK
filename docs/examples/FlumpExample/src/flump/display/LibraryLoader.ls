...
public delegate ResultDictionary(result:Dictionary.<String, Object>);
public delegate ResultLibrary(result:LibraryMold);
...
public class LibraryLoader
{
     ...
     * loading failure.
     */
    public static function fromBytes (bytes :ByteArray, executor :Executor=null,
    ...
    */
     ...
     */
    public const fileLoaded :ResultDictionary;

    /**
     * Dispatched when the library mold has been read from the archive.
     */
    public const libraryMoldLoaded :ResultLibrary;
     ...
     */
    public const atfAtlasLoaded :ResultDictionary;
     ...
     */
    public const pngAtlasLoaded :ResultDictionary;
    ...
    public function loadBytes (bytes :ByteArray) :Future {
        Debug.assert(bytes != null);
        return (_executor != null ? _executor : new Executor(1)).submit(
