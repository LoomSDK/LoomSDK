...
package feathers.display
{
    ...
    //import Loom2D.Core.RenderSupport;
    ...
    public class Scale9Image extends Sprite
    {
        ...
        public function Scale9Image(textures:Scale9Textures, textureScale:Number = 1)
        {
            ...
            Debug.assert(textureScale != null && textureScale > 0, "Need to have an affine scale.");
         ...
         * @private
         */
        private var _smoothing:String = "bilinear"; //TextureSmoothing.BILINEAR;
        ...
        {
            Debug.assert(this._frame != null, "Must have a valid frame!");
