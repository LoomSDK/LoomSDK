...
package feathers.events
{
    ...
    public class ExclusiveTouch extends EventDispatcher
    {
         ...
         * @private
         */
        protected static const stageToObject:Dictionary.<String, Object> = new Dictionary.<String, Object>(true);
        ...
        protected function stage_touchHandler(event:TouchEvent):void
        {
            for(var key:Object in this._claims)
            {
                ...
                var touch:Touch = event.getTouch(this._stage, TouchPhase.ENDED);
                if(!touch || touch.id != touchID)
                {
                    continue;
                }
                this._claims[key] = null;
                this._stageListenerCount--;
            }
            if(this._stageListenerCount == 0)
            {
