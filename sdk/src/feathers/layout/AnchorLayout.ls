...
package feathers.layout
{
     ...
     *
     * **Beta Layout:** This is a new layout, and its APIs
    ...
    public class AnchorLayout extends EventDispatcher implements ILayout
    {
        ...
        public function layout(items:Vector.<DisplayObject>, viewPortBounds:ViewPortBounds = null, result:LayoutBoundsResult = null):LayoutBoundsResult
        {
            ...
            if(needsWidth || needsHeight)
            {
                ...
                HELPER_POINT = this.measureViewPort(items, viewPortWidth, viewPortHeight);
                if(needsWidth)
                {
         ...
         * @private
         */
        protected function measureViewPort(items:Vector.<DisplayObject>, viewPortWidth:Number, viewPortHeight:Number):Point
        {
            ...
            HELPER_POINT = this.measureVector(items, otherVector);
            ...
            while(currentLength > 0)
            {
                ...
                HELPER_POINT = this.measureVector(mainVector, otherVector);
         ...
         * @private
         */
        protected function measureVector(items:Vector.<DisplayObject>, unpositionedItems:Vector.<DisplayObject>):Point
        {
            ...
            for(var i:int = 0; i < itemCount; i++)
            {
                ...
                this.measureItem(item, HELPER_POINT);
            }
        ...
        protected function isReferenced(item:DisplayObject, items:Vector.<DisplayObject>):Boolean
        {
            ...
            for(var i:int = 0; i < itemCount; i++)
            {
                ...
                if(!otherItem || otherItem as Object == item as Object)
                {
                    continue;
                }
