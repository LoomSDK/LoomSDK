...
package feathers.controls
{
    ...
    public class PickerList extends FeathersControl
    {
        ...
        /**
         * The default value added to the `nameList` of the button. This
        ...
        /**
         * The default value added to the `nameList` of the pop-up list. This
         * variable is `protected` so that sub-classes can customize
         * the list name in their constructors instead of using the default
         * name defined by `DEFAULT_CHILD_NAME_LIST`.
         *
         ...
         * empty string.
         *
         * **Important:** This value only affects the selected
         * item displayed by the picker list's button control. It will _not_
         * affect the label text of the pop-up list's item renderers.
         *
         * @see #labelFunction
         */
         ...
         * The button must be an instance of `Button`. This factory
         ...
         * instance that is created by `buttonFactory`.
         *
         ...
         *
         * Setting properties in a `buttonFactory` function
         * instead of using `buttonProperties` will result in better
         * performance.
         *
         * @see #buttonFactory
         * @see feathers.controls.Button
         ...
         * `feathers.controls.List` instance that is created by
         * `listFactory`.
         *
         * If the subcomponent has its own subcomponents, their properties
         * can be set too, using attribute `&#64;` notation. For example,
         ...
         * `list.scrollerProperties.&#64;verticalScrollBarProperties.&#64;thumbProperties.defaultSkin = new Image(texture);`
         *
         * Setting properties in a `listFactory` function
         * instead of using `listProperties` will result in better
         * performance.
         *
         * @see #listFactory
         * @see feathers.controls.List
