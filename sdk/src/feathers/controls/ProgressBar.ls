...
package feathers.controls
{
    ...
    public class ProgressBar extends FeathersControl
    {
         ...
         *
         * Note: The size of the `fillSkin`, at the time that it
         ...
         * `fillSkin` should have a width of 0 when you pass it in.
         * On the other hand, if you're using a `Scale9Image` as the
         * skin, it may require a minimum width before the image parts begin to
         * overlap. In that case, the `Scale9Image` instance passed
         * to the `fillSkin` setter should have a `width`
