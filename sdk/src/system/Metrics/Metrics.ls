...
package system.metrics {
    ...
    /**
     *  Provides metrics about the Loom app during runtime.
     */
    native class Metrics {
        
        /**
         *  Gets the number of Managed Native objects currently in memory for a specified classpath.
         *  
         *  @param classPath The fully qualified classpath that represents a managed native class.
