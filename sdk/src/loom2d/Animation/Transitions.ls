...
{
    import system.errors.AbstractClassError;
     ...
     *  in the range 0-1: `function myTransition(ratio:Number):Number`.
     */
    ...
    {        
        ...
        {
            if (ratio < 0.5) return 0.5 * startFunc.call(null, ratio*2.0);
            else             return 0.5 * endFunc.call(null, (ratio-0.5)*2.0) + 0.5;
        }
    }
}