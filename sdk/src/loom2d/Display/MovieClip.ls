...
package loom2d.display
{
    ...
    public class MovieClip extends Image implements IAnimatable
    {
        ...
        private function init(textures:Vector.<Texture>, fps:Number):void
        {
            ...
            mSounds = new Vector.<String>(numFrames);
        ...
        public function addFrame(texture:Texture, sound:String=null, duration:Number=-1):void
        {
