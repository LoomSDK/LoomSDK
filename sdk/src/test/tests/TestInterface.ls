...
class ClassIA implements ISimpleB {
    ...
    public function doSomething(svalue:String):Number {
        ...
        LegacyTest.log("ClassIA::doSomething " + svalue);
        return 1;
    ...
    public function doSomethingElse(svalue:String):Number {
        ...
        LegacyTest.log("ClassIA::doSomethingElse" + svalue);
        return 101;
...
class ClassIB extends ClassIA implements ISimpleC, ISimpleD {
    ...
    public function doSomethingElse(svalue:String):Number {
        ...
        super(svalue);
        LegacyTest.log("ClassIB::doSomethingElse " + svalue);
        return 3;
    ...
    public function doSomethingCompletelyDifferent(svalue:String):Number {
        ...
        LegacyTest.log("ClassIB::doSomethingCompletelyDifferent " + svalue);
        return 4;
    
    }
    
    public function logCreepShow() {
        LegacyTest.log("Creepshow");
    }
...
class TestInterface extends LegacyTest
{
    function test()
    {
        ...
        LegacyTest.log(cb is ISimpleA);
        LegacyTest.log(cb is ISimpleB);
        LegacyTest.log(cb is ISimpleC);
        LegacyTest.log(cb is ISimpleD);
        LegacyTest.log((cb as ISimpleC) != null);
        LegacyTest.log(cb is ISimpleE);
