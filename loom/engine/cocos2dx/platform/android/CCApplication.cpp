...
void CCApplication::setAnimationInterval(double interval)
{
    ...
    {
        methodInfo.getEnv()->CallStaticVoidMethod(methodInfo.classID, methodInfo.methodID, interval);
    }
}
...
extern "C"
{
void evenMoreMadness();
}

extern void *Java_org_cocos2dx_lib_Cocos2dxRenderer_hack_function_ref[];

void *hack_function_ref[] =
{
    (void *)evenMoreMadness,
    (void *)Java_org_cocos2dx_lib_Cocos2dxRenderer_hack_function_ref
};
