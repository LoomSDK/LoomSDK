...
//TODO: LOOM-953 evaluate alternaive to FMOD on linux platform
...
{
    return false;    //oAudioPlayer->willPlayBackgroundMusic();
}


bool SimpleAudioEngine::isBackgroundMusicPlaying()
{
    return false;    //oAudioPlayer->isBackgroundMusicPlaying();
}
...
unsigned int SimpleAudioEngine::playEffect(const char *pszFilePath,
                                           bool       bLoop)
{
    return 0;    //oAudioPlayer->playEffect(pszFilePath, bLoop);
}
...
{
    return 0;    //oAudioPlayer->getBackgroundMusicVolume();
}
