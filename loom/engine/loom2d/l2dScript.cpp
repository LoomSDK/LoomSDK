...
static int registerLoom2D(lua_State *L)
{
    ...
    // Stage
       ...
       .addVarAccessor("onGameControllerButtonUp", &Stage::getGameControllerButtonUpDelegate)
       .addVarAccessor("onGameControllerButtonDown", &Stage::getGameControllerButtonDownDelegate)
       .addVarAccessor("onGameControllerAxisMoved", &Stage::getGameControllerAxisMovedDelegate)
