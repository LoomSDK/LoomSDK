...
bool b2Body::IsTouchingContact(const b2Contact* other)
{
    if (m_contactList->contact == other)
    {
        return true;
    }
    else
...
bool b2Body::IsContactEnabled(const b2Contact* contact)
{
    b2ContactEdge* edge = m_contactList;
    int currentContactIndex = 0;
