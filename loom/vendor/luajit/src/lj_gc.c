...
#define LUA_GC_DEFINE(name) LUA_GC_GLOBAL(callback) LUA_GC_GLOBAL(name)

#define LUA_GC_RANGE(name) \
    LUA_GC_GLOBAL(callback_begin) LUA_GC_GLOBAL(name ## _begin); \
    LUA_GC_GLOBAL(callback_end)   LUA_GC_GLOBAL(name ## _end); \
