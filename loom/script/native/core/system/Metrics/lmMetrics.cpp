...
public:
    ...
    static int getManagedObjectCount(const char *path, lua_State *L)
    {
...
{
    NativeInterface::registerNativeType<Metrics>(registerSystemMetrics);
}
