package co.theengine.loomplayer.billing;

import co.theengine.loomplayer.LoomPlayer;
...
public class LoomStore 
{
    ...
    {
        _activity = activity;
        _billingAllowed = LoomPlayer.checkPermission(_activity, "android.permission.BILLING");
        if(_billingAllowed)
        {
