...
public class LoomTeak 
{
    ...
    public static void onCreate(LoomPlayer loomPlayer, String facebookAppId) 
    {
        activity = LoomAdMob.activity;
        if(mTeak == null) 
        {
            String teakKey = LoomPlayer.getMetadataString(loomPlayer, TEAK_SECRET_KEY);
            ...
            {
                mTeak = new Carrot(loomPlayer, facebookAppId, teakKey);
